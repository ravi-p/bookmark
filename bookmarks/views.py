...
def logout_page(request):
    logout(request)
    return HttpResponseRedirect('/')#it redirects to the new template upon successful registration
...
# below is block of code for  register page validation and generate responce
...
def contact_page(request):
    ...
    variables = RequestContext(request, {'form': form})
    return render_to_response('registration/contact.html',variables)
